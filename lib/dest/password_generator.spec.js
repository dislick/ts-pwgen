...
describe('PasswordGenerator', () => {
    ...
    describe('#passwordLength()', () => {
        it('should return the password length for 1 part passwords', () => {
            ...
            chai_1.expect(pwgen.passwordLength).to.be.equal(30);
        });
        it('should return the password length for 2 part passwords', () => {
            ...
            chai_1.expect(pwgen.passwordLength).to.be.equal(21); // 10 chars + delimiter + 10 chars
        });
        it('should return the password length for 3 part passwords', () => {
            ...
            chai_1.expect(pwgen.passwordLength).to.be.equal(17);
        });
        it('should return the password length for delimiters > 1 char', () => {
            ...
            chai_1.expect(pwgen.passwordLength).to.be.equal(53);
        });
        it('should return the password length for delimiters > 1 char', () => {
            let pwgen = new password_generator_1.PasswordGenerator({
                lowercaseLetters: true,
            ...
            chai_1.expect(pwgen.passwordLength).to.be.equal(36);
        });
    });
});
